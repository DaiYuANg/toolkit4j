...
class DateTimeFormatsTest {
  ...
  void commonPatternsExposeStablePrimaryValues() {
    ...
    assertSame(
        ...
        EnumValues.lookup(DateTimePattern.class).fromPrimaryValue("yyyy-MM-dd"));
  }
  ...
  void knownPatternResolvesFormatterFromEnumPreset() {
    ...
    assertEquals(
        "2026-03-26 08:09:10",
        DateTimeFormats.of(DateTimePattern.STANDARD_DATE_TIME).format(value));
  ...
  void isoFormattersRemainAvailableThroughUtilityClass() {
    ...
    assertEquals(
        "2026-03-26T08:09:10+08:00", DateTimeFormats.ISO_OFFSET_DATE_TIME.format(offsetDateTime));
  }
}
