...
/**
 * @author spleaner see <a
 *     href="http://developer.apple.com/documentation/Cocoa/Reference/ObjCRuntimeRef/Reference/reference.html">Documentation</a>
 */
...
public final class Foundation {
  ...
  public static ID invoke(final ID id, final Pointer selector, Object... args) {
    ...
    // on x86_64 this does not make a difference, but arm64 uses a different calling convention
    // for
    // varargs
  ...
  public static ID invokeVarArg(final ID id, final Pointer selector, Object... args) {
    ...
    return myFoundationLibrary.objc_msgSend(
        id, selector, args[0], Arrays.copyOfRange(args, 1, args.length));
  }
  ...
  public static ID safeInvoke(final String stringCls, final String stringSelector, Object... args) {
    ...
    if (!invoke(cls, "respondsToSelector:", selector).booleanValue()) {
      throw new RuntimeException(
          String.format("Missing selector %s for %s", stringSelector, stringCls));
    }
    ...
    if (!id.equals(ID.NIL) && !invoke(id, "respondsToSelector:", selector).booleanValue()) {
      throw new RuntimeException(
          String.format(
              ...
              stringSelector, toStringViaUTF8(invoke(id, "description"))));
    }
   ...
   * @param impl A function which is the implementation of the new method. The function must take at
   *     least two arguments-self and _cmd.
   * @param types An array of characters that describe the types of the arguments to the method. See
   *     <a
   *     href="https://developer.apple.com/library/IOs/documentation/Cocoa/Conceptual/ObjCRuntimeGuide/Articles/ocrtTypeEncodings.html#//apple_ref/doc/uid/TP40008048-CH100"></a>
  ...
  public static @NotNull ID nsUUID(String uuid) {
    return invoke(
        invoke(invoke("NSUUID", "alloc"), "initWithUUIDString:", nsString(uuid)), "autorelease");
  }
  ...
  public static void executeOnMainThread(
    ...
    synchronized (RUNNABLE_LOCK) {
      ...
      ourMainThreadRunnables.put(
          runnableCountString, new RunnableInfo(runnable, withAutoreleasePool));
    }
   ...
   *
   * <p>Warning: NOT THREAD-SAFE! Must be called under lock. Danger of segmentation fault.
   */
  ...
  private static final class NSString {
    ...
    private static final Pointer initWithBytesLengthEncodingSel =
        createSelector("initWithBytes:length:encoding:");
    private static final long nsEncodingUTF16LE =
