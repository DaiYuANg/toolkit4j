...
public interface FoundationLibrary extends Library {
  ...
  // ID CGWindowListCreateImage(Foundation.NSRect screenBounds, int windowOption, ID windowID, int
  // imageOption);
  ...
  double objc_msgSend_fpret(
      ID receiver,
      Pointer selector,
      Object... args); // the same as objc_msgSend but returns double (32-bit only)
