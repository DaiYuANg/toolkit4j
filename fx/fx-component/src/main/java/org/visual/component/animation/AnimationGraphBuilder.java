...
public class AnimationGraphBuilder<T extends AlgebraData<T>> {
  ...
  public static <T extends AlgebraData<T>> AnimationGraphBuilder<T> simpleTwoNodeGraph(
      AnimationNode<T> a, AnimationNode<T> b, long millis) {
  ...
  public AnimationGraphBuilder<T> addEdge(
      AnimationNode<T> from, AnimationNode<T> to, long durationMillis) {
  ...
  public AnimationGraphBuilder<T> addTwoWayEdge(
      AnimationNode<T> from, AnimationNode<T> to, long durationMillis) {
  ...
  public AnimationGraphBuilder<T> setStateTransferBeginCallback(
