...
public class Viewport {
  ...
  private final DoublePropertyBase vposProperty =
      new DoublePropertyBase(getVpos()) {
        {
          container
              .layoutYProperty()
              .addListener(
  ...
  private final DoublePropertyBase hposProperty =
      new DoublePropertyBase(getHpos()) {
        {
          container
              .layoutXProperty()
              .addListener(
